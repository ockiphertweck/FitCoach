    ...
    <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              ...
              <Input
                ...
                onChange={(e) =>
                  setProfileForm((p) => ({
                    ...p,
                    vo2max: e.target.value ? Number(e.target.value) : null,
                  }))
                }
              />
            </div>
            ...
            <div className="space-y-1 col-span-2">
              ...
              <Textarea
                ...
                onChange={(e) =>
                  setProfileForm((p) => ({ ...p, preferences: e.target.value || null }))
                }
              />
            </div>
          </div>
      ...
      <Card>
        <CardHeader className="pt-5 px-5">
          ...
          <CardDescription>
            Required for AI recommendations and coaching. Get a key at console.anthropic.com.
          </CardDescription>
        </CardHeader>
        <CardContent className="px-5 pb-5 space-y-4">
          {hasAnthropicKey ? (
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <Badge
                  variant="outline"
                  className="border-emerald-400/40 bg-emerald-50 text-emerald-700"
                >
      ...
      <Card>
        <CardHeader className="pt-5 px-5">
          ...
          <CardDescription>
            Connect Strava to import activities automatically via OAuth.
          </CardDescription>
        </CardHeader>
